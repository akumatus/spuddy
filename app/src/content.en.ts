...
export const EN: TextPack = {
  ...
  // Generic golden-tier fallback — the last resort when a golden draw can't
  // reach the LLM and the active buddy has no voiced pool below.
  rare: [
  ...
  // Per-character golden fallback — when the LLM is unreachable, a golden draw
  // still lands in the active buddy's own voice. Keep each line short
  // (~22 words), no emoji, no quotes, no tag — mirroring the ai-golden prompt.
  golden: {
    spud: [
